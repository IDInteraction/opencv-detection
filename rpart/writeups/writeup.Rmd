...
load("../analysis/tableCombined.RData")
...
```{r}
load("../analysis/tableOpenCV.RData")
...
A recursive partitioning tree, using all of the covariates used in the face-tracking (`r as.character(rhs.vars(table1formula))`) and face-detection (`as.character(rhs.vars(openCVFormula)`) was used to 
