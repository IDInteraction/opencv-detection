...
# Example works, but far too slow for our data
# From https://github.com/randel/MixRF/blob/master/R/MixRFb.r
# And see http://stats.stackexchange.com/questions/156600/random-forest-for-binary-panel-data
# https://www.gerad.ca/en/papers/G-2010-39/view
