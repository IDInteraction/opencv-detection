...
allparticipants <- loadExperimentData(participants,
                                      trackingLoc = "~/opencv/setBoundingBox/output/",
...
table1predictionsSetBB <- allpredictions
table1SetBB <- table1

save(table1SetBB, table1formula, table1predictionsSetBB, file = "table1SetBB.RData")
