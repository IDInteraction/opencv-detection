...
allparticipants <- loadExperimentData(participants,
                                      trackingLoc = "~/opencv/openCVboundingbox/output/",
...
table1predictionsOpenCVBB <- allpredictions
table1OpenCVBB <- table1

save(table1OpenCVBB, table1formula, table1predictionsOpenCVBB, file = "table1OpenCVBB.RData")
